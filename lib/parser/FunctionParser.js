...
var FunctionParser = /** @class */ (function (_super) {
    __extends(FunctionParser, _super);
    function FunctionParser(docNode) {
        var _this = _super.call(this, docNode) || this;
        _this.init(docNode);
        return _this;
    }
    FunctionParser.prototype.init = function (docNode) {
        this._code = this.getCode(docNode);
        this.parseDocComment(docNode);
    };
    FunctionParser.prototype.getCode = function (docNode) {
